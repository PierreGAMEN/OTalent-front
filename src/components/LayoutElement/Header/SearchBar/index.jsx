  ...
  return (
    <form className="join lg:flex" onSubmit={handleSubmit}>
      <button
        ...
        className="btn join-item border-none mr-[2px] bg-white hover:bg-white material-symbols-rounded"
      ...
      <button
        className="btn join-item border-none ml-[2px] bg-white hover:bg-white"
        type="submit"
        onClick={e => {
          e.preventDefault();
          ...
          if (idSelectedCategory) params.append('id', idSelectedCategory);
