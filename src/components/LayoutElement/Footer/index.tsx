    ...
    return (
        <footer className="p-5 bg-primary-color text-white bottom-0">
            <div className="flex flex-row justify-center items-center gap-10">
                <div className="flex flex-col md:flex-row w-2/3 justify-evenly gap-10">
            ...
            <div className="flex flex-col lg:flex-row w-full mt-5 gap-5 items-center justify-center">
                <a href="/" className="">
